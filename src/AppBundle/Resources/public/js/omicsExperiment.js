...
function addStatusForm($collectionHolder, $newStatusLinkLi) {
    ...
    addStatusFormDeleteLink($newFormLi);
}

function addStatusFormDeleteLink($statusFormLi) {
    var $removeFormA = $('<a href="#">delete this status</a>');
    $statusFormLi.append($removeFormA);
